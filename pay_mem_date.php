<html>
<head>
<title>RDFL Create Member's Payment</title>
...
<form method="post" action="pay_mem_date_shw.php">
<input type="hidden" name="posted" value="true">
<table width="68%" border="3" align="center">
<tr><th width="20%" nowrap><b>CODE:</b></th>
<td width="20%"><input type="text" name="code" size="10" maxlength="8" autofocus required></td>
</tr>
<tr>
