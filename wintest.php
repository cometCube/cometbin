...
<input type="button" value="Import New Rate-Chart" onclick="javascript:openwin('import_rate.php');">
<input type="button" value="Create Payment" onclick="javascript:openwin('pooling_mem_srch.php');">
</body>
</html>